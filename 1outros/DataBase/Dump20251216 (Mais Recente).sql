...
INSERT INTO `despesas` VALUES (2,'Renda',300.00,'Fixa',1,'2025-12-14 20:19:29'),(3,'Teste',200.00,'Variavel',1,'2025-12-14 20:19:56'),(4,'teste',1000.00,'Fixa',1,'2025-12-16 18:16:43');
...
CREATE TABLE `orcamentos` (
  ...
  `percentagem_alerta` decimal(5,2) DEFAULT '80.00',
  `data_criacao` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_user_category` (`id_utilizador`,`categoria`),
  CONSTRAINT `orcamentos_ibfk_1` FOREIGN KEY (`id_utilizador`) REFERENCES `utilizadores` (`id`) ON DELETE CASCADE
...
INSERT INTO `orcamentos` VALUES (1,8,'Transporte',50.00,90.00,'2025-12-11 12:28:39');
...
CREATE TABLE `receitas` (
  ...
  `tipo` enum('Salário','Extra','Outro') NOT NULL DEFAULT 'Extra',
  `data_recebimento` date NOT NULL,
  `id_utilizador` int NOT NULL,
  `data_criacao` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_receita`),
  KEY `fk_receitas_utilizadores1_idx` (`id_utilizador`),
  CONSTRAINT `fk_receitas_utilizadores1` FOREIGN KEY (`id_utilizador`) REFERENCES `utilizadores` (`id`) ON DELETE CASCADE
...
INSERT INTO `receitas` VALUES (3,'Teste',800.00,'Extra','2025-12-16',1,'2025-12-16 18:16:09');
...
INSERT INTO `utilizadores` VALUES (1,'AntonioTeste','teste@teste.com','$2y$10$wPYAEgEyt7QAC0iqlkGTs.cXcG23I9BoXGYgBVyWNJhtqI0qoCidq',18,'Estudante','Académico',2300.00,1),(2,'teste','teste2@teste.com','$2y$10$HklehyWuYQkSWX5l75c2Sepi3ueo0Eqf9/6WCU.7b2vYEv0tG6ACa',NULL,NULL,NULL,NULL,1),(3,'teste','teste2@teste.com','$2y$10$xT/WazNnIJ7o3glb.6TXIO8J1aldWwf.ST7HJCJTtQoAOeTWsgbi6',NULL,NULL,NULL,NULL,1),(4,'Antonio','antoniorpvalente@gmail.com','$2y$10$gNrNCVavkBsL9wlg0cMUUOMwhFvmEX3cvK7lpxgStF/ejJ4Ox94ie',18,'Estudante','Académico',950.00,1),(5,'AntonioVa','antoniorpvalente@gmail.com','$2y$10$240a2cRKAmKQdD.4BCNZ5eUN6io/JGNe8W63rYhsS6TVl74QwbwuG',22,'Estudante','Académico',950.00,1),(6,'AntonioTeste2','teste4@teste4.com','$2y$10$CBaqpWAxAv9ZNAXewpW9N.b2a82.M0aFNQ9xIIvAszFuKaLISklny',18,'Trabalhador','Outro',950.00,1),(7,'AntonioTeste3','teste3@teste4.com','$2y$10$CqvrWXwyT.S3r8oIx3t58.lf6GsmCqw4YiUEdcwrhzufBvijo4rT6',18,'Trabalhador','Outro',950.00,1),(8,'Ryan','ryanpossan14@gmail.com','$2y$10$.byo9z4BT3Ss6sAytlSMWuM1/ZdQHHwx.hRNQKjH59DD1CTwJfUbO',18,'Estudante','Académico',1200.00,1),(9,'AntonioTeste5','teste5@teste.com','$2y$10$4iwuhwbpRt8wJmjxiROcmelaamjyWg1E4Mz4DVdhFaHpYufzNisxa',20,'Trabalhador','Social Ativo',950.00,1);
...
-- Dump completed on 2025-12-16 19:11:18
